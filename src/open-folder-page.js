...
function editProject(folderObj) {
    ...
    saveProjectActionBtn.addEventListener('click', ()=> saveProjectEdit(folderObj));
    saveProjectActionBtn.setAttribute('class', 'mainActionBtns mainProjectActionBtn');
...
function deleteProject(folderObj) {
    ...
    const index = projectObjects.findIndex((projectObj) => projectObj.projectId == folderObj.projectId);
...
function removeEditProjectContainer() {
    const projectSettingContainer = document.querySelector('#editProjectContainer');
